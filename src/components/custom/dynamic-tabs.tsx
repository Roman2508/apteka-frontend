...
//     {
//       id: '1',
//       title: 'Пташник Роман / 1123 каса зав прро / Зміна 1123-000679 від 14.11.2025 21:24:56 (Відкрита): 1:52 год',
//       type: 'counterparty',
//     },
//   ])
...
//       const newActive = filtered[closedIndex] || filtered[closedIndex - 1] || filtered[0]
...
//         <div ref={tabsListRef} className="flex items-center justify-between pr-4">
