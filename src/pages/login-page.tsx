...
import { useLogin, useCheckSetup, useSetup } from '../hooks/use-auth';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow-md">
        ...
        {mode === 'setup' ? (
             ...
             <div className='mb-4'>
               <label className='text-[13px] text-neutral-900' htmlFor="username">Admin Username:*</label>
             ...
             <div className='mb-4'>
               <label className='text-[13px] text-neutral-900' htmlFor="password">Password:*</label>
               <Input  type="password" placeholder="Create password (min 6 chars)" {...form.register('password')} id="password" />
            ...
            <div className='mb-4'>
                <label className='text-[13px] text-neutral-900' htmlFor="username">Login:*</label>
            ...
            <Button type="submit" variant="primary" className='w-full mt-4' disabled={login.isPending}>{login.isPending ? 'Signing in...' : 'Sign in & Start Shift'}</Button>
